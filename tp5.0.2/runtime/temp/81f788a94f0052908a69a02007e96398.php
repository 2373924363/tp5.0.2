<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:95:"E:\tupian\php\php\wamp64\wamp64\www\supermall\public/../application/index\view\index\index.html";i:1545134282;s:21:"../public/header.html";i:1540649702;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
<div class="zhong" style="">
    ...
    <?php if(is_array($list) || $list instanceof \think\Collection): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?>
           ...
           <tr >
            ...
            <td><a href="caozuo.html?id=<?php echo $user['s_xh']; ?>">编辑</a></td>
            <td><a href="shan?id=<?php echo $user['s_xh']; ?>">删除</a></td>
        </tr>
...
<?php echo $list->render(); ?>
    ...
    <?php if(is_array($list) || $list instanceof \think\Collection): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?>
           <tr >
            ...
            <td><?php echo $user['s_photo']; ?></td>
            <td><?php echo $user['s_sheng']; ?></td>
            <td><?php echo $user['s_di']; ?></td>
            <td><a href="caozuo2.html?id=<?php echo $user['s_xh']; ?>">编辑</a></td>
        </tr>
<?php endforeach; endif; else: echo "" ;endif; ?>
